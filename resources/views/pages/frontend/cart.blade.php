      ...
      <div class="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="1">
        <div class="px-4 flex-none">
          <div class="" style="width: 90px; height: 90px">
            <img
            src="{{$c->product->galleries->first()? Storage::url($c->product->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=='}}"
            alt="chair-1"
        ...
        <div class="px-4 w-auto flex-1 md:w-5/12">
          <div class="">
            ...
            >
            {{number_format($c->product->price)}}
          </h6>
        </div>
      </div>
      <div class="px-4 w-auto flex-none md:flex-1 md:w-5/12 hidden md:block">
        <div class="">
          <h6 class="font-semibold text-lg">{{number_format($c->product->price)}}</h6>
        </div>
      </div>
      <div class="px-4 w-2/12">
        <div class="text-center">
      ...
      <form action="{{route('checkout')}}" method="post">
        ...
        <div class="flex flex-col mb-4">
          ...
          <div class="flex -mx-2 flex-wrap">
            ...
            <div class="px-2 w-6/12 h-24 mb-4">
              <button type="button"data-value="dhl"
              data-name="courier" class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none">
      ...
      <div class="flex flex-col mb-4">
        ...
        <div class="flex -mx-2 flex-wrap">
          ...
          <div class="px-2 w-6/12 h-24 mb-4">
            ...
            data-name="payment" class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none">
