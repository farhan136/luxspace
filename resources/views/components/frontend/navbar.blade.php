 <!-- START: HEADER -->
    <header class="{{ \Route::current()->getName() == 'index'? 'absolute' : '' }} w-full z-50 px-4"> <!-- jika route current adalah incex maka tampilkan class absolute, jika tidak maka tidak perlu class absolute -->
